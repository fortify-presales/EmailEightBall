...
Write-Host "scancentral -url $ScanCentralCtrlUrl -ssctoken $SSCAuthToken start -upload -uptoken $ScanCentralCtrlToken -b $AppName --application $AppName --application-version $AppVersion -email $ScanCentralEmail -bt gradle -bf build.gradle -scan"
